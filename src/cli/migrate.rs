...
mod tests {
    ...
    use super::{
        BoundedLineReader, EventBudget, MAX_EVENT_DESTINATION_COUNT, MAX_EVENT_FRAME_BYTES,
        MAX_EVENT_GZIP_EXPANSION_BYTES, MAX_EVENT_PAIR_COUNT, MAX_EVENT_TOTAL_DECOMPRESSED_BYTES,
        MAX_EVENT_TOTAL_OUTPUT_SPOOL_BYTES, MAX_EVENT_TOTAL_RAW_BYTES, manifest_path,
