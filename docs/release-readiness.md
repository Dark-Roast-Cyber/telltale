...
the next `0.5.0-rc.5` candidate for the approved `0.5.0` Event 3.0 migration;
...
is the prior candidate; `rc.5` is the next prepared candidate.
...
`main`, tag only that reviewed commit as `v0.5.0-rc.5`, and inspect the workflow
