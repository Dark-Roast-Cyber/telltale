...
release-artifact-manifest:
	...
	for archive in $$archives; do \
		...
		expected_sorted="$$(printf '%s\n' $$binaries "LICENSE" "README.md" "config/examples/telltale-outputs.yaml" "config/examples/adr-scan.service" "config/examples/adr-scan.timer" "config/examples/adr-scan-task.xml" "config/examples/elastic-telltale-index-template.json" | sort)"; \
