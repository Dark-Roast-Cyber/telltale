...
.PHONY: build install uninstall clean test fmt clippy check event3-contract-check producer-provenance-check evaluation-check evaluation-report detection-v2-shadow-check detection-v2-shadow-report security-tools security-tool-versions security-audit security-deny security-sbom-test workflow-pins-check security-check release-sbom public-push-review release-context-check release-tag-review release-crate-manifest release-artifact-manifest release-canonical-identity-check release-public-docs-check release-fixture-smoke release-preflight package-manifest package-verify status logs scan-dry scan help
...
## Verify the deterministic producer and detector provenance manifest
...
release-preflight: release-context-check release-tag-review release-crate-manifest release-canonical-identity-check event3-contract-check producer-provenance-check package-verify release-public-docs-check release-artifact-manifest check release-fixture-smoke
